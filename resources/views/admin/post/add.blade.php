            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="inputDescription">likes_number</label>
                            <textarea id="inputDescription"   name="likes_number"class="form-control" ></textarea>
                        </div>
                        <div class="form-group">
                            <label for="inputDescription">User_id</label>
                            <textarea id="inputDescription"   name="User_id"class="form-control" rows="4"></textarea>
                        </div>
